...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	СведенияОАдминистраторахПользователей = СведенияОАдминистраторахПользователей(База);
	
	ВнешниеНаборыДанных = Новый Структура;
	ВнешниеНаборыДанных.Вставить("СведенияОПользователях", СведенияОАдминистраторахПользователей);
...
Функция СведенияОАдминистраторахПользователей(База)
	
	Результат = УправлениеПользователями.ПолучитьСписокПользователейСПравом("Администрирование", База);
