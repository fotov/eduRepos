...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Вставить(Метаданные.Подсистемы.НепрерывнаяИнтеграция);
	НастройкиОтчета.Описание = "Сравнивает этапы задач по данным Метеора и Репоса";
