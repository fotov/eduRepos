...
Процедура ПриОпределенииНазначенияРолей(НазначениеРолей) Экспорт
	//+++ tura, 2023.03.29
	НазначениеРолей.ТолькоДляАдминистраторовСистемы.Добавить("АдминистрированиеРасширений");
	НазначениеРолей.ТолькоДляАдминистраторовСистемы.Добавить("ПолныеПраваУК");
	//---
КонецПроцедуры
