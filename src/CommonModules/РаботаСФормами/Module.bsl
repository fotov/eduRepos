...
// https://github.com/puretruth/form-program-modification
////////////////////////////////////////////////////////////////////////////////
...
//  Форма - ФормаКлиентскогоПриложения - Форма.
//  Имя - Строка - Имя реквизита.
//  ОписанияКолонок - Массив - Массив описания колонок. См. ДобавитьОписаниеКолонкиТаблицы()
// 
// Возвращаемое значение:
//  РеквизитФормы - описание созданного реквизита формы.
//
Функция ДобавитьРеквизитТаблицаЗначений(Форма, Имя, ОписанияКолонок = Неопределено) Экспорт
	
	ДобавляемыеРеквизиты = Новый Массив;
	ДобавляемыйРеквизит = ДобавляемыеРеквизитыДобавитьТаблицу(ДобавляемыеРеквизиты, Имя, ОписанияКолонок);
...
// Конструктор описания колонки таблицы для добавления реквизита
//
// Параметры:
//  Имя	 - Строка - Имя добавляемой колонки
//  Тип	 - Строка - Тип добавляемой колонки
//  Заголовок	 - Строка - Заголовок колонки таблицы формы. используется при выводе
// 
// Возвращаемое значение:
//  Структура
//
Функция ОписаниеКолонкиТаблицы(Имя, Тип, Заголовок = Неопределено) Экспорт
	Возврат Новый Структура("Имя, Тип, Заголовок", Имя, Тип, Заголовок);
КонецФункции

// Добавляет новое описание колонки таблицы в массив описаний колонок
//
// Параметры:
//  МассивКолонок	 - Массив - Массив описаний колонок добавляемой таблицы
//  Имя				 - Строка - см. ОписаниеКолонкиТаблицы 
//  Тип				 - Строка - см. ОписаниеКолонкиТаблицы
//  Заголовок		 - Строка - см. ОписаниеКолонкиТаблицы
//
Процедура ДобавитьОписаниеКолонкиТаблицы(МассивКолонок, Имя, Тип, Заголовок = Неопределено) Экспорт
	МассивКолонок.Добавить(ОписаниеКолонкиТаблицы(Имя, Тип, Заголовок));
КонецПроцедуры
...
Функция ДобавитьКартинку(
	...
	НовыйЭлемент.Картинка = ?(ТипЗнч(Картинка)  = Тип("Строка"), БиблиотекаКартинок[Картинка], Картинка);
...
//	Имя - Строка - Уникальное имя добавляемого элемента.
//	Родитель	- Строка, ЭлементФормы - Имя элемента или элемент формы.
//	ОписанияКолонокТаблицы 	- Массив, Неопределено -
//			Значения ключей:
//			* Имя - имя колонки,
...
Функция ДобавитьДинамическийСписок(
		...
		Имя,
		Родитель = Неопределено,
		ОписанияКолонокТаблицы = Неопределено,
		ТекстЗапроса = "",
...
Функция ДобавитьТаблицуФормы(
	...
	Если Не ОписанияКолонокТаблицы = Неопределено Тогда
		ДобавитьКолонкиТаблицыФормы(Форма, ТаблицаФормы, ОписанияКолонокТаблицы);
	КонецЕсли;
...
//				Может быть пустым (Неопределено), тогда представление колонки будет сформировано системой автоматически.
//
Процедура ДобавитьКолонкиТаблицыФормы(Форма, ТаблицаФормы, ОписанияКолонокТаблицы)
