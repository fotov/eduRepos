...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	// Подключение разделов к подсистеме ВариантыОтчетов
	Разделы.Добавить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы(), "Главное");
	Разделы.Добавить(Метаданные.Подсистемы.Дополнения, "Отчеты по дополнениям");
	Разделы.Добавить(Метаданные.Подсистемы.КачествоИМетрики, "Отчеты по качеству и метрикам");
	Разделы.Добавить(Метаданные.Подсистемы.НепрерывнаяИнтеграция, "Отчеты по непрерывной интеграции");
	Разделы.Добавить(Метаданные.Подсистемы.Тестирование, "Отчеты по тестированию");
	Разделы.Добавить(Метаданные.Подсистемы.ТехническийПроект, "Отчеты по техническому проекту");
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// При добавлении отчёт следует добавить в массив, если настройки вариантов отчёта по-умолчанию
	ДобавленныеОтчеты = Новый Массив();
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.Метрики);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.МетрикиРазработки);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.СведенияОДополнениях);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.АдминистраторыРасширений);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.АдминистраторыПользователей);
//	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.АдминистраторыВнешнихОбработок);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.АнализТрудозатрат);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.ОчередьСогласованияТрудозатрат);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.КонтрольИзмененияОбъектовМетаданных);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.ПропускиПроверкиАПК);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.ОценкаКачестваКода);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.КонтрольИзмененнныхОбъектов);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.КонтрольИзмененнныхОбъектовSQL);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.СтатистикаПоЛогическимПодсистемам);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.СтатистикаАвтоматическогоСогласованияПереноса);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.АнализСинтаксическойПроверки);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.АнализИзмененийСвойствОбъектов);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.ЗахваченныеОбъектыХранилищ);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.КонтрольЗаписиРабочихДанных);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.КонтрольЭтаповЗадачМетеор);
	ДобавленныеОтчеты.Добавить(Метаданные.Отчеты.ТестированиеКонвейеров);
	
	Для Каждого МетаданныеОтчета Из ДобавленныеОтчеты Цикл
