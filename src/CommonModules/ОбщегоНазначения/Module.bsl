...
Функция МинимальнаяВерсияПлатформы() Экспорт // АПК:581 - экспортная, так как используется при тестировании.
	...
	// Установленный и используемый из БСП функционал допустим на текущей версии.
	Возврат "8.3.17.2760; 8.3.18.1363; 8.3.19.1723; 8.3.20.2180; 8.3.21.1622; 8.3.22.1704";
	// --- tura, 2023.03.29
