...
Процедура ЗаполнитьПодсистемыПраваИОтветственныхПоОбъектам(Конфигурация, ТаблицаОбъектов)
	...
	Запрос.Текст = 
		...
		|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ ОбъектыМетаданныхПрава.Роль) КАК КоличествоРолей
		...
		|	ЕСТЬNULL(ПраваНаОбъектыМетаданных.КоличествоРолей, 0) КАК КоличествоРолей,
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ПраваНаОбъектыМетаданных КАК ПраваНаОбъектыМетаданных
